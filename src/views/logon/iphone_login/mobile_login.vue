           ...
           <div class="left_logon">
               ...
               <div class="input_logon" style="margin-top:24px">
                   ...
                   <div class="input-view">
                           <input type="text" placeholder="请输入电话号码" length="11" class="logon-input" v-model="mobile">
               ...
               <div class="input_logon" style="margin-top:24px">
                   ...
                   <button class="right-btn" v-if="disabled" @click="getcode();waitcode()">获取验证码</button>
                ...
                denglu(){
                    var that=this
                           axios.post('http://43.142.239.198/user/login', qs.stringify({
                               code:that.code,mobile:this.mobile,
                               })).then(function(res) {
                                    console.log(res)
